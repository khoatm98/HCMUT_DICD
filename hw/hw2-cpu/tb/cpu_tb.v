...
//
// Files (generated by `make`, relative to the run dir):
//   sim/imem.hex    instruction image      (asm)
//   sim/dmem.hex    initial data image     (asm)
//   sim/golden.hex  expected FINAL data    (iss)
// =============================================================================
`timescale 1ns/1ps
...
module cpu_tb;
    ...
    initial begin
        ...
        $readmemh("sim/imem.hex",   imem);
        $readmemh("sim/dmem.hex",   dmem);
        $readmemh("sim/golden.hex", golden);
        errors = 0;

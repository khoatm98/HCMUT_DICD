...
//
// Reads the committed public golden vectors in 00_TB/golden/ and checks every
...
// in a clocked, waveform-friendly way (open build/alu.vcd in GTKWave).
// =============================================================================
`timescale 1ns/1ps
...
`include "alu_count.vh"          // defines N_VECTORS (generated)
    ...
    initial begin
        clk = 1'b0;
        errors = 0;
        $readmemh("../00_TB/golden/alu_vectors.hex", vec);
